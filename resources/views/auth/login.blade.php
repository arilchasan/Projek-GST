...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 items-center">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Login GST
        </h2>
    </div>
    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-3" action="/auth/login-add" method="POST">
            ...
            <div class="text-sm mb-2">
                <a href="/auth/forgot-password" class="font-semibold text-indigo-600 hover:text-indigo-500">Lupa password?</a>
            </div>
            <div>
                <button type="submit"
        ...
        <p>Belum punya akun? <a href="/auth/register" class="font-semibold hover:underline">Daftar</a></p>
    </div>
</div>
